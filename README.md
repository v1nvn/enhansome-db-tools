...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 48,650 | 🐛 3,217 | 🌐 Java | 📅 2026-02-11 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,796 | 🐛 427 | 🌐 Pascal | 📅 2026-02-11 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Querybook](https://github.com/pinterest/querybook) ⭐ 2,230 | 🐛 199 | 🌐 TypeScript | 📅 2026-02-10 - Pinterest open-source Big Data Querying UI, combining collocated table metadata and a simple notebook IDE interface.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 33,912 | 🐛 173 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 21,986 | 🐛 1,042 | 🌐 TypeScript | 📅 2026-02-12 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
* [Robo 3T](https://github.com/Studio3T/robomongo) ⭐ 9,370 | 🐛 724 | 🌐 C++ | 📅 2022-09-22 - Shell-centric cross-platform MongoDB management tool.
* [Pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,252 | 🐛 41 | 🌐 Go | 📅 2026-02-01 - Web-based database browser for PostgreSQL, written in Go and works on macOS, Linux and Windows machines.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,792 | 🐛 907 | 🌐 PHP | 📅 2026-02-11 - A web interface for MySQL and MariaDB.
* [Azure Data Studio](https://github.com/microsoft/azuredatastudio) ⭐ 7,716 | 🐛 2,604 | 🌐 TypeScript | 📅 2026-02-11 - A data management tool that enables working with SQL Server, PostgreSQL, Azure SQL DB and SQL DW from Windows, macOS and Linux.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,294 | 🐛 232 | 🌐 Objective-C | 📅 2026-02-09 - MySQL/MariaDB database management for macOS.
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,260 | 🐛 20 | 🌐 PHP | 📅 2026-02-08 - Database management in a single PHP file.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,557 | 🐛 19 | 🌐 Go | 📅 2026-02-11 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
* [TablePlus](https://github.com/TablePlus/TablePlus) ⭐ 3,720 | 🐛 1,400 | 📅 2024-03-15 - Modern, native, and friendly GUI tool for relational databases: MySQL, PostgreSQL, SQLite & more.
* [OmniDB](https://github.com/OmniDB/OmniDB) ⭐ 3,276 | 🐛 328 | 🌐 JavaScript | 📅 2023-02-01 - Web tool for database management.
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,127 | 🐛 5 | 🌐 Java | 📅 2026-02-08 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [usql](https://github.com/xo/usql) ⭐ 9,807 | 🐛 101 | 🌐 Go | 📅 2026-01-11 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,019 | 🐛 59 | 🌐 Python | 📅 2026-01-17 - PostgreSQL CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,869 | 🐛 12 | 🌐 Python | 📅 2026-02-11 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,718 | 🐛 144 | 🌐 Go | 📅 2026-02-12 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,207 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,526 | 🐛 240 | 🌐 Java | 📅 2026-01-28 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,076 | 🐛 239 | 🌐 Go | 📅 2026-02-07 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,417 | 🐛 678 | 🌐 Java | 📅 2026-02-10 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 2,845 | 🐛 7 | 🌐 Go | 📅 2026-02-05 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [Skeema](https://github.com/skeema/skeema) ⭐ 1,357 | 🐛 16 | 🌐 Go | 📅 2026-02-04 - Declarative pure-SQL schema management system for MySQL and MariaDB, with support for sharding and external online schema change tools.
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,571 | 🐛 177 | 🌐 JavaScript | 📅 2026-02-11 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,136 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-11 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,696 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-11 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
* [Azimutt](https://github.com/azimuttapp/azimutt) ⭐ 2,045 | 🐛 78 | 🌐 Elm | 📅 2025-07-07 - An Entity Relationship diagram (ERD) visualization tool, with various filters and inputs to help understand your database schema.
...
* [DBML](https://github.com/holistics/dbml) ⭐ 3,513 | 🐛 104 | 🌐 JavaScript | 📅 2026-02-12 - Database Markup Language, designed to define and document database structures.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,899 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-11 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,507 | 🐛 381 | 🌐 Haskell | 📅 2026-02-08 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-11 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
...
* [DreamFactory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,735 | 🐛 64 | 🌐 Shell | 📅 2026-02-11 - A open source REST API backend for mobile, web, and IoT applications.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 546 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-12 - Turn multiple data sources into a single GraphQL API.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,083 | 🐛 4,433 | 🌐 TypeScript | 📅 2026-02-12 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,422 | 🐛 983 | 🌐 JavaScript | 📅 2026-02-11 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,642 | 🐛 307 | 🌐 TypeScript | 📅 2026-02-11 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,370 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-11 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,078 | 🐛 106 | 🌐 TypeScript | 📅 2026-02-12 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,438 | 🐛 114 | 🌐 Rust | 📅 2026-02-07 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,991 | 🐛 675 | 🌐 JavaScript | 📅 2026-02-11 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,497 | 🐛 5 | 🌐 Go | 📅 2026-02-10 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,594 | 🐛 56 | 🌐 C | 📅 2026-02-10 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 2,718 | 🐛 62 | 🌐 Python | 📅 2026-01-20 - Backup and Recovery Manager for PostgreSQL.
* [pgcopydb](https://github.com/dimitri/pgcopydb) ⭐ 1,406 | 🐛 94 | 🌐 C | 📅 2025-04-28 - Copy a PostgreSQL database to a target PostgreSQL server (pg\_dump | pg\_restore on steroids).
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 322 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-11 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,690 | 🐛 449 | 🌐 Go | 📅 2026-02-11 - Provides metrics for your PostgreSQL database.
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,786 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - A performance dashboard for PostgreSQL - health checks, suggested indexes, and more.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 172 | 🌐 Go | 📅 2026-02-12 - Open source platform for managing and monitoring MySQL and MongoDB performance.
* [pgMonitor](https://github.com/CrunchyData/pgmonitor) ⭐ 695 | 🐛 16 | 🌐 PLpgSQL | 📅 2026-02-05 - All-in-one tool to easily create an environment to visualize the health and performance of your PostgreSQL cluster.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 386 | 🐛 37 | 🌐 Go | 📅 2026-02-09 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,406 | 🐛 344 | 🌐 Go | 📅 2026-02-11 - Prometheus exporter for PostgreSQL server metrics.
* [pg\_exporter](https://github.com/Vonng/pg_exporter) ⭐ 295 | 🐛 13 | 🌐 Go | 📅 2026-02-10 - Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,689 | 🐛 906 | 🌐 Go | 📅 2026-02-12 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,674 | 🐛 352 | 🌐 Java | 📅 2026-02-12 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,282 | 🐛 1,049 | 🌐 C | 📅 2026-02-11 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,151 | 🐛 74 | 🌐 Python | 📅 2026-01-29 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,916 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-09 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Percona XtraDB Cluster](https://github.com/percona/percona-xtradb-cluster) ⭐ 376 | 🐛 11 | 🌐 C++ | 📅 2026-02-03 - A High Scalability Solution for MySQL Clustering and High Availability.
...
* [PostgreSQL operator](https://github.com/zalando/postgres-operator) ⭐ 5,080 | 🐛 556 | 🌐 Go | 📅 2026-02-06 - The PostgreSQL Operator enables highly-available PostgreSQL clusters on Kubernetes (Kubernetes) powered by Patroni.
* [Spilo](https://github.com/zalando/spilo) ⭐ 1,786 | 🐛 144 | 🌐 Python | 📅 2026-02-06 - HA PostgreSQL Clusters with Docker.
...
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,432 | 🐛 37 | 🌐 Perl | 📅 2026-01-18 - Script written in Perl that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,691 | 🐛 146 | 🌐 Makefile | 📅 2026-02-11 - Full-featured PostgreSQL installation packaged as a standard Mac app.
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,663 | 🐛 16 | 🌐 Shell | 📅 2026-02-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,725 | 🐛 178 | 🌐 PowerShell | 📅 2026-02-11 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,492 | 🐛 589 | 🌐 Python | 📅 2026-02-11 - Dialect-flexible and configurable SQL linter.
...
* [SQL Formatter](https://github.com/zeroturnaround/sql-formatter) ⭐ 2,816 | 🐛 72 | 🌐 TypeScript | 📅 2026-01-30 - JavaScript library for pretty-printing SQL queries.
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,899 | 🐛 20 | 🌐 PLpgSQL | 📅 2026-02-05 - A PostgreSQL SQL syntax beautifier.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,903 | 🐛 5 | 🌐 Python | 📅 2026-02-11 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,656 | 🐛 2,147 | 🌐 Java | 📅 2026-02-11 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,913 | 🐛 114 | 🌐 Java | 📅 2026-01-26 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 3,992 | 🐛 255 | 🌐 Python | 📅 2025-12-19 - Non-validating SQL parser for Python.
* [libpg\_query](https://github.com/pganalyze/libpg_query) ⭐ 1,427 | 🐛 49 | 🌐 C | 📅 2026-02-07 - C library for accessing the PostgreSQL parser outside of the server environment.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,100 | 🐛 670 | 🌐 C++ | 📅 2026-02-11 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,539 | 🐛 2,518 | 🌐 Java | 📅 2026-02-12 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 39 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,690 | 🐛 22 | 🌐 Go | 📅 2026-02-10 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,321 | 🐛 156 | 🌐 Go | 📅 2026-02-09 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
* [OctoSQL](https://github.com/cube2222/octosql) ⭐ 5,211 | 🐛 49 | 🌐 Go | 📅 2024-05-26 - Query tool that allows you to join, analyse and transform data from multiple databases and file formats using SQL.
...
* [csvq](https://github.com/mithrandie/csvq) ⭐ 1,608 | 🐛 26 | 🌐 Go | 📅 2024-07-25 - SQL-like query language for CSV.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,347 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-02 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,235 | 🐛 810 | 🌐 Python | 📅 2026-02-12 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,571 | 🐛 744 | 🌐 Java | 📅 2026-02-12 - The Metadata Platform for the Modern Data Stack.
...
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,119 | 🐛 238 | 🌐 Java | 📅 2026-02-11 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,863 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-11 - Generate massive amounts of fake data in the browser and Node.js.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 466 | 🐛 81 | 🌐 C++ | 📅 2026-02-07 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

### Replication

* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,184 | 🐛 32 | 🌐 Go | 📅 2026-02-12 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,443 | 🐛 176 | 🌐 Python | 📅 2026-02-12 - In-database Machine Learning.
