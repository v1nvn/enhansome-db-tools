...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 49,091 | 🐛 3,243 | 🌐 Java | 📅 2026-03-13 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,845 | 🐛 355 | 🌐 Pascal | 📅 2026-03-13 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 22,200 | 🐛 1,049 | 🌐 TypeScript | 📅 2026-03-13 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,826 | 🐛 924 | 🌐 PHP | 📅 2026-03-13 - A web interface for MySQL and MariaDB.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,329 | 🐛 195 | 🌐 Objective-C | 📅 2026-03-12 - MySQL/MariaDB database management for macOS.
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,298 | 🐛 26 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,679 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Antares SQL](https://github.com/antares-sql/antares) ⭐ 2,575 | 🐛 142 | 🌐 Vue | 📅 2025-10-14 - A modern, fast and productivity driven SQL client with a focus in UX. Available for Mac, Linux and Windows.
...
* [usql](https://github.com/xo/usql) ⭐ 9,863 | 🐛 101 | 🌐 Go | 📅 2026-03-03 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [iredis](https://github.com/laixintao/iredis) ⭐ 2,727 | 🐛 50 | 🌐 Python | 📅 2026-03-13 - A Cli for Redis with AutoCompletion and Syntax Highlighting.
...
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,887 | 🐛 16 | 🌐 Python | 📅 2026-03-13 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,817 | 🐛 145 | 🌐 Go | 📅 2026-03-13 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,249 | 🐛 323 | 🌐 Go | 📅 2026-03-12 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,589 | 🐛 245 | 🌐 Java | 📅 2026-03-09 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,167 | 🐛 248 | 🌐 Go | 📅 2026-03-08 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,452 | 🐛 607 | 🌐 Java | 📅 2026-03-13 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,034 | 🐛 7 | 🌐 Go | 📅 2026-03-10 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,883 | 🐛 195 | 🌐 JavaScript | 📅 2026-03-12 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,506 | 🐛 144 | 🌐 TypeScript | 📅 2026-03-13 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,922 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-12 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,654 | 🐛 387 | 🌐 Haskell | 📅 2026-03-14 - REST API for any PostgreSQL database.
...
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,826 | 🐛 664 | 🌐 Python | 📅 2026-03-12 - A tool for exploring and publishing data.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,372 | 🐛 4,442 | 🌐 TypeScript | 📅 2026-03-13 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,597 | 🐛 951 | 🌐 JavaScript | 📅 2026-03-13 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,726 | 🐛 308 | 🌐 TypeScript | 📅 2026-03-13 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,357 | 🐛 42 | 🌐 TypeScript | 📅 2026-02-22 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,104 | 🐛 108 | 🌐 TypeScript | 📅 2026-03-13 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,478 | 🐛 117 | 🌐 Rust | 📅 2026-03-13 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,997 | 🐛 674 | 🌐 JavaScript | 📅 2026-03-13 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,988 | 🐛 3 | 🌐 Go | 📅 2026-03-13 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,654 | 🐛 69 | 🌐 C | 📅 2026-03-13 - Reliable PostgreSQL Backup & Restore.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 571 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-13 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 985 | 🐛 175 | 🌐 Go | 📅 2026-03-13 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 393 | 🐛 41 | 🌐 Go | 📅 2026-03-13 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,446 | 🐛 346 | 🌐 Go | 📅 2026-03-04 - Prometheus exporter for PostgreSQL server metrics.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,844 | 🐛 941 | 🌐 Go | 📅 2026-03-13 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,702 | 🐛 321 | 🌐 Java | 📅 2026-03-14 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,366 | 🐛 1,051 | 🌐 C | 📅 2026-03-13 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,235 | 🐛 73 | 🌐 Python | 📅 2026-03-05 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,032 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,449 | 🐛 41 | 🌐 Perl | 📅 2026-03-12 - Script written in Perl that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,705 | 🐛 146 | 🌐 Makefile | 📅 2026-03-12 - Full-featured PostgreSQL installation packaged as a standard Mac app.
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,886 | 🐛 19 | 🌐 Shell | 📅 2026-03-13 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,735 | 🐛 142 | 🌐 PowerShell | 📅 2026-03-13 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,588 | 🐛 521 | 🌐 Python | 📅 2026-03-13 - Dialect-flexible and configurable SQL linter.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,913 | 🐛 19 | 🌐 PLpgSQL | 📅 2026-03-12 - A PostgreSQL SQL syntax beautifier.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,024 | 🐛 5 | 🌐 Python | 📅 2026-03-13 - Pure Python SQL parser, transpiler, and builder.
...
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,928 | 🐛 82 | 🌐 Java | 📅 2026-03-13 - Parses an SQL statement and translate it into a hierarchy of Java classes.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,168 | 🐛 654 | 🌐 C++ | 📅 2026-03-12 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,635 | 🐛 2,574 | 🌐 Java | 📅 2026-03-13 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,728 | 🐛 25 | 🌐 Go | 📅 2026-03-10 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,423 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,391 | 🐛 771 | 🌐 Python | 📅 2026-03-13 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,657 | 🐛 789 | 🌐 Java | 📅 2026-03-14 - The Metadata Platform for the Modern Data Stack.
...
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,137 | 🐛 240 | 🌐 Java | 📅 2026-03-13 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,971 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-12 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,427 | 🐛 299 | 🌐 Python | 📅 2026-03-03 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 469 | 🐛 87 | 🌐 C++ | 📅 2026-03-13 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

### Replication

* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,339 | 🐛 28 | 🌐 Go | 📅 2026-03-13 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,719 | 🐛 184 | 🌐 Python | 📅 2026-03-13 - In-database Machine Learning.
