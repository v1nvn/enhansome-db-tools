...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 48,995 | 🐛 3,255 | 🌐 Java | 📅 2026-03-08 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,830 | 🐛 371 | 🌐 Pascal | 📅 2026-03-06 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Querybook](https://github.com/pinterest/querybook) ⭐ 2,242 | 🐛 210 | 🌐 TypeScript | 📅 2026-03-07 - Pinterest open-source Big Data Querying UI, combining collocated table metadata and a simple notebook IDE interface.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 34,006 | 🐛 176 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 22,156 | 🐛 1,043 | 🌐 TypeScript | 📅 2026-03-09 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,819 | 🐛 925 | 🌐 PHP | 📅 2026-03-08 - A web interface for MySQL and MariaDB.
...
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,293 | 🐛 25 | 🌐 PHP | 📅 2026-02-12 - Database management in a single PHP file.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,668 | 🐛 35 | 🌐 Go | 📅 2026-03-08 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,147 | 🐛 5 | 🌐 Java | 📅 2026-03-03 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [usql](https://github.com/xo/usql) ⭐ 9,856 | 🐛 100 | 🌐 Go | 📅 2026-03-03 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,014 | 🐛 137 | 🌐 Python | 📅 2026-01-21 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,061 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - PostgreSQL CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,883 | 🐛 15 | 🌐 Python | 📅 2026-03-08 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,207 | 🐛 35 | 🌐 Python | 📅 2026-02-15 - CLI for SQLite Databases with auto-completion and syntax highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,792 | 🐛 143 | 🌐 Go | 📅 2026-03-09 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,237 | 🐛 327 | 🌐 Go | 📅 2026-03-09 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,579 | 🐛 244 | 🌐 Java | 📅 2026-02-27 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,146 | 🐛 245 | 🌐 Go | 📅 2026-03-08 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,445 | 🐛 682 | 🌐 Java | 📅 2026-03-09 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,022 | 🐛 8 | 🌐 Go | 📅 2026-03-04 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,845 | 🐛 195 | 🌐 JavaScript | 📅 2026-03-08 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,466 | 🐛 140 | 🌐 TypeScript | 📅 2026-03-04 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,728 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-01 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
* [Azimutt](https://github.com/azimuttapp/azimutt) ⭐ 2,092 | 🐛 78 | 🌐 Elm | 📅 2025-07-07 - An Entity Relationship diagram (ERD) visualization tool, with various filters and inputs to help understand your database schema.
...
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,551 | 🐛 297 | 🌐 HTML | 📅 2026-03-05 - Generating your database to HTML documentation, including Entity Relationship diagrams.
* [DBML](https://github.com/holistics/dbml) ⭐ 3,534 | 🐛 112 | 🌐 JavaScript | 📅 2026-03-08 - Database Markup Language, designed to define and document database structures.
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,787 | 🐛 0 | 🌐 HTML | 📅 2026-03-09 - A free database schema discovery and comprehension tool.
...
* [Oracle Database Sample Schemas](https://github.com/oracle/db-sample-schemas) ⭐ 900 | 🐛 3 | 🌐 PLSQL | 📅 2025-06-25 - Sample schemas for Oracle Database.

## API

Building API for your Data

* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,915 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-03-06 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,626 | 🐛 383 | 🌐 Haskell | 📅 2026-03-09 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,911 | 🐛 151 | 🌐 TypeScript | 📅 2026-03-06 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,814 | 🐛 663 | 🌐 Python | 📅 2026-03-07 - A tool for exploring and publishing data.
* [prest](https://github.com/prest/prest) ⭐ 4,529 | 🐛 145 | 🌐 Go | 📅 2026-03-07 - Is a way to serve a RESTful API from any databases written in Go.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,350 | 🐛 4,438 | 🌐 TypeScript | 📅 2026-03-08 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,558 | 🐛 957 | 🌐 JavaScript | 📅 2026-03-09 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,718 | 🐛 305 | 🌐 TypeScript | 📅 2026-03-08 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,354 | 🐛 42 | 🌐 TypeScript | 📅 2026-02-22 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,097 | 🐛 101 | 🌐 TypeScript | 📅 2026-03-08 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,474 | 🐛 116 | 🌐 Rust | 📅 2026-03-09 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,995 | 🐛 671 | 🌐 JavaScript | 📅 2026-03-08 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,877 | 🐛 3 | 🌐 Go | 📅 2026-03-08 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,640 | 🐛 65 | 🌐 C | 📅 2026-03-07 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 2,739 | 🐛 58 | 🌐 Python | 📅 2026-01-20 - Backup and Recovery Manager for PostgreSQL.
* [pgcopydb](https://github.com/dimitri/pgcopydb) ⭐ 1,421 | 🐛 95 | 🌐 C | 📅 2025-04-28 - Copy a PostgreSQL database to a target PostgreSQL server (pg\_dump | pg\_restore on steroids).
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 556 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-08 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,751 | 🐛 432 | 🌐 Go | 📅 2026-03-05 - Provides metrics for your PostgreSQL database.
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,802 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - A performance dashboard for PostgreSQL - health checks, suggested indexes, and more.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 983 | 🐛 183 | 🌐 Go | 📅 2026-03-09 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,851 | 🐛 942 | 🌐 Go | 📅 2026-03-09 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,700 | 🐛 321 | 🌐 Java | 📅 2026-03-09 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,354 | 🐛 1,046 | 🌐 C | 📅 2026-03-06 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,211 | 🐛 71 | 🌐 Python | 📅 2026-03-05 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,007 | 🐛 32 | 🌐 TypeScript | 📅 2026-03-09 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [PostgreSQL operator](https://github.com/zalando/postgres-operator) ⭐ 5,106 | 🐛 556 | 🌐 Go | 📅 2026-03-02 - The PostgreSQL Operator enables highly-available PostgreSQL clusters on Kubernetes (Kubernetes) powered by Patroni.
...
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,732 | 🐛 171 | 🌐 PowerShell | 📅 2026-03-08 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [Databunker](https://github.com/securitybunker/databunker) ⭐ 1,391 | 🐛 5 | 🌐 Go | 📅 2026-02-19 - Special GDPR compliant secure vault for customer records built on top of regular DB.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,576 | 🐛 542 | 🌐 Python | 📅 2026-03-08 - Dialect-flexible and configurable SQL linter.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,911 | 🐛 19 | 🌐 PLpgSQL | 📅 2026-03-06 - A PostgreSQL SQL syntax beautifier.
...
* [JSQLFormatter](https://github.com/manticore-projects/jsqlformatter) ⭐ 41 | 🐛 7 | 🌐 PLpgSQL | 📅 2026-03-09 - Open Source Java SQL Formatter for many RDBMS based on JSqlParser.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,998 | 🐛 2 | 🌐 Python | 📅 2026-03-08 - Pure Python SQL parser, transpiler, and builder.
...
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,925 | 🐛 83 | 🌐 Java | 📅 2026-03-08 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 3,999 | 🐛 256 | 🌐 Python | 📅 2025-12-19 - Non-validating SQL parser for Python.
* [libpg\_query](https://github.com/pganalyze/libpg_query) ⭐ 1,436 | 🐛 51 | 🌐 C | 📅 2026-02-07 - C library for accessing the PostgreSQL parser outside of the server environment.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,157 | 🐛 662 | 🌐 C++ | 📅 2026-03-08 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,621 | 🐛 2,572 | 🌐 Java | 📅 2026-03-09 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,727 | 🐛 22 | 🌐 Go | 📅 2026-03-01 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,338 | 🐛 154 | 🌐 Go | 📅 2026-03-09 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,272 | 🐛 43 | 🌐 Go | 📅 2026-03-07 - SQL Language Server written in Go.
...
* [Advanced SQL Puzzles](https://github.com/smpetersgithub/AdvancedSQLPuzzles) ⭐ 859 | 🐛 0 | 🌐 TSQL | 📅 2026-01-23 - Difficult set-based SQL puzzles.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,409 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-07 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [postgres\_dba](https://github.com/NikolayS/postgres_dba) ⭐ 1,242 | 🐛 2 | 🌐 PLpgSQL | 📅 2026-02-10 - The missing set of useful tools for PostgreSQL DBAs and all engineers.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,350 | 🐛 791 | 🌐 Python | 📅 2026-03-08 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,629 | 🐛 773 | 🌐 Java | 📅 2026-03-09 - The Metadata Platform for the Modern Data Stack.
...
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,132 | 🐛 241 | 🌐 Java | 📅 2026-03-08 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,959 | 🐛 129 | 🌐 TypeScript | 📅 2026-03-09 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,413 | 🐛 296 | 🌐 Python | 📅 2026-03-03 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,325 | 🐛 31 | 🌐 Go | 📅 2026-03-09 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,656 | 🐛 193 | 🌐 Python | 📅 2026-03-06 - In-database Machine Learning.
