...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 48,593 | 🐛 3,229 | 🌐 Java | 📅 2026-02-07 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,791 | 🐛 470 | 🌐 Pascal | 📅 2026-02-07 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 33,899 | 🐛 173 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 21,952 | 🐛 1,038 | 🌐 TypeScript | 📅 2026-02-07 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,790 | 🐛 908 | 🌐 PHP | 📅 2026-02-08 - A web interface for MySQL and MariaDB.
* [Azure Data Studio](https://github.com/microsoft/azuredatastudio) ⭐ 7,715 | 🐛 2,603 | 🌐 TypeScript | 📅 2026-02-07 - A data management tool that enables working with SQL Server, PostgreSQL, Azure SQL DB and SQL DW from Windows, macOS and Linux.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,291 | 🐛 232 | 🌐 Objective-C | 📅 2026-01-02 - MySQL/MariaDB database management for macOS.
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,252 | 🐛 21 | 🌐 PHP | 📅 2026-02-08 - Database management in a single PHP file.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,547 | 🐛 33 | 🌐 Go | 📅 2026-02-07 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,123 | 🐛 5 | 🌐 Java | 📅 2026-02-05 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [Tabix](https://github.com/tabixio/tabix) ⭐ 2,281 | 🐛 46 | 🌐 TypeScript | 📅 2023-01-15 - SQL Editor & Open source simple business intelligence for Clickhouse.
* [sqlite-tui](https://github.com/mathaou/sqlite-tui) ⭐ 1,814 | 🐛 6 | 🌐 Go | 📅 2022-06-11 - A TUI for viewing SQLite databases, written in Go.
* [SQLTools](https://github.com/mtxr/vscode-sqltools) ⭐ 1,717 | 🐛 313 | 🌐 TypeScript | 📅 2026-02-07 - Database management for VSCode.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,003 | 🐛 124 | 🌐 Python | 📅 2026-01-21 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,015 | 🐛 60 | 🌐 Python | 📅 2026-01-17 - PostgreSQL CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,867 | 🐛 17 | 🌐 Python | 📅 2026-02-07 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,696 | 🐛 140 | 🌐 Go | 📅 2026-02-07 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
...
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,054 | 🐛 240 | 🌐 Go | 📅 2026-02-07 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,415 | 🐛 675 | 🌐 Java | 📅 2026-02-04 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 2,794 | 🐛 5 | 🌐 Go | 📅 2026-02-05 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,440 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-08 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 35,861 | 🐛 175 | 🌐 JavaScript | 📅 2026-02-07 - Free, simple, and intuitive online database design tool and SQL generator.
...
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,688 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-04 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
...
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,534 | 🐛 297 | 🌐 HTML | 📅 2026-01-26 - Generating your database to HTML documentation, including Entity Relationship diagrams.
...
* [pgmodeler](https://github.com/pgmodeler/pgmodeler) ⭐ 3,479 | 🐛 264 | 🌐 C++ | 📅 2026-02-06 - Data modeling tool designed for PostgreSQL.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,892 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-06 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,474 | 🐛 371 | 🌐 Haskell | 📅 2026-02-08 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,900 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-07 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,744 | 🐛 653 | 🌐 Python | 📅 2026-02-06 - A tool for exploring and publishing data.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,051 | 🐛 4,432 | 🌐 TypeScript | 📅 2026-02-06 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,400 | 🐛 981 | 🌐 JavaScript | 📅 2026-02-07 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,627 | 🐛 304 | 🌐 TypeScript | 📅 2026-02-06 - Low-code platform for creating internal apps in minutes.
...
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,067 | 🐛 101 | 🌐 TypeScript | 📅 2026-02-06 - The Open Source Firebase Alternative with GraphQL.
...
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,990 | 🐛 667 | 🌐 JavaScript | 📅 2026-02-07 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,419 | 🐛 5 | 🌐 Go | 📅 2026-02-05 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,584 | 🐛 52 | 🌐 C | 📅 2026-02-07 - Reliable PostgreSQL Backup & Restore.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,685 | 🐛 440 | 🌐 Go | 📅 2026-02-06 - Provides metrics for your PostgreSQL database.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,678 | 🐛 900 | 🌐 Go | 📅 2026-02-08 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,672 | 🐛 363 | 🌐 Java | 📅 2026-02-08 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
...
* [patroni](https://github.com/zalando/patroni) ⭐ 8,139 | 🐛 71 | 🌐 Python | 📅 2026-01-29 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,903 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-07 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spilo](https://github.com/zalando/spilo) ⭐ 1,784 | 🐛 144 | 🌐 Python | 📅 2026-02-06 - HA PostgreSQL Clusters with Docker.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,686 | 🐛 146 | 🌐 Makefile | 📅 2026-02-04 - Full-featured PostgreSQL installation packaged as a standard Mac app.
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,605 | 🐛 15 | 🌐 Shell | 📅 2026-02-07 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,725 | 🐛 178 | 🌐 PowerShell | 📅 2026-02-08 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,474 | 🐛 596 | 🌐 Python | 📅 2026-02-08 - Dialect-flexible and configurable SQL linter.
...
* [ZetaSQL](https://github.com/google/zetasql) ⭐ 2,579 | 🐛 102 | 🌐 C++ | 📅 2026-01-31 - Analyzer Framework for SQL.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,898 | 🐛 19 | 🌐 PLpgSQL | 📅 2026-02-05 - A PostgreSQL SQL syntax beautifier.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,890 | 🐛 28 | 🌐 Python | 📅 2026-02-06 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,652 | 🐛 2,153 | 🌐 Java | 📅 2026-02-05 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
...
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 3,991 | 🐛 254 | 🌐 Python | 📅 2025-12-19 - Non-validating SQL parser for Python.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,082 | 🐛 670 | 🌐 C++ | 📅 2026-02-04 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,527 | 🐛 2,510 | 🌐 Java | 📅 2026-02-08 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 39 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,684 | 🐛 39 | 🌐 Go | 📅 2026-02-07 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
...
* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,258 | 🐛 44 | 🌐 Go | 📅 2026-01-07 - SQL Language Server written in Go.
...
* [Advanced SQL Puzzles](https://github.com/smpetersgithub/AdvancedSQLPuzzles) ⭐ 846 | 🐛 0 | 🌐 TSQL | 📅 2026-01-23 - Difficult set-based SQL puzzles.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,345 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-02 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,215 | 🐛 802 | 🌐 Python | 📅 2026-02-08 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,547 | 🐛 732 | 🌐 Java | 📅 2026-02-08 - The Metadata Platform for the Modern Data Stack.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,853 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-06 - Generate massive amounts of fake data in the browser and Node.js.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 465 | 🐛 80 | 🌐 C++ | 📅 2026-02-07 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

### Replication

* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,164 | 🐛 32 | 🌐 Go | 📅 2026-02-08 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,418 | 🐛 172 | 🌐 Python | 📅 2026-02-07 - In-database Machine Learning.
