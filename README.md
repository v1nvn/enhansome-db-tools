...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 48,661 | 🐛 3,221 | 🌐 Java | 📅 2026-02-12 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,799 | 🐛 421 | 🌐 Pascal | 📅 2026-02-12 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Querybook](https://github.com/pinterest/querybook) ⭐ 2,231 | 🐛 201 | 🌐 TypeScript | 📅 2026-02-12 - Pinterest open-source Big Data Querying UI, combining collocated table metadata and a simple notebook IDE interface.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 33,917 | 🐛 174 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 21,996 | 🐛 1,045 | 🌐 TypeScript | 📅 2026-02-12 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,793 | 🐛 907 | 🌐 PHP | 📅 2026-02-12 - A web interface for MySQL and MariaDB.
* [Azure Data Studio](https://github.com/microsoft/azuredatastudio) ⭐ 7,715 | 🐛 2,604 | 🌐 TypeScript | 📅 2026-02-12 - A data management tool that enables working with SQL Server, PostgreSQL, Azure SQL DB and SQL DW from Windows, macOS and Linux.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,295 | 🐛 232 | 🌐 Objective-C | 📅 2026-02-12 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,558 | 🐛 17 | 🌐 Go | 📅 2026-02-12 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Antares SQL](https://github.com/antares-sql/antares) ⭐ 2,549 | 🐛 143 | 🌐 Vue | 📅 2025-10-14 - A modern, fast and productivity driven SQL client with a focus in UX. Available for Mac, Linux and Windows.
...
* [SQLTools](https://github.com/mtxr/vscode-sqltools) ⭐ 1,719 | 🐛 312 | 🌐 TypeScript | 📅 2026-02-09 - Database management for VSCode.
...
* [usql](https://github.com/xo/usql) ⭐ 9,810 | 🐛 105 | 🌐 Go | 📅 2026-01-11 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [iredis](https://github.com/laixintao/iredis) ⭐ 2,723 | 🐛 60 | 🌐 Python | 📅 2026-02-05 - A Cli for Redis with AutoCompletion and Syntax Highlighting.
* [pspg](https://github.com/okbob/pspg) ⭐ 2,687 | 🐛 0 | 🌐 C | 📅 2026-01-23 - PostgreSQL Pager.
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,004 | 🐛 125 | 🌐 Python | 📅 2026-01-21 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,020 | 🐛 59 | 🌐 Python | 📅 2026-01-17 - PostgreSQL CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,870 | 🐛 12 | 🌐 Python | 📅 2026-02-12 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,721 | 🐛 142 | 🌐 Go | 📅 2026-02-13 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,208 | 🐛 322 | 🌐 Go | 📅 2026-02-10 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,529 | 🐛 240 | 🌐 Java | 📅 2026-02-12 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,079 | 🐛 239 | 🌐 Go | 📅 2026-02-07 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,421 | 🐛 679 | 🌐 Java | 📅 2026-02-12 - Database-independent library for tracking, managing and applying database schema changes.
* [Sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,100 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Sensible database-native change management for framework-free development and dependable deployment.
* [migra](https://github.com/djrobstep/migra) ⭐ 3,052 | 🐛 86 | 🌐 Python | 📅 2025-08-25 - Like diff but for PostgreSQL schemas.
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 2,919 | 🐛 6 | 🌐 Go | 📅 2026-02-12 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,441 | 🐛 55 | 🌐 TypeScript | 📅 2026-02-12 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,593 | 🐛 180 | 🌐 JavaScript | 📅 2026-02-11 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,142 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-11 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,697 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-11 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
* [Azimutt](https://github.com/azimuttapp/azimutt) ⭐ 2,046 | 🐛 78 | 🌐 Elm | 📅 2025-07-07 - An Entity Relationship diagram (ERD) visualization tool, with various filters and inputs to help understand your database schema.
* [ERAlchemy](https://github.com/Alexis-benoist/eralchemy) ⭐ 1,398 | 🐛 10 | 🌐 Python | 📅 2026-01-12 - Entity Relation Diagrams generation tool.
...
* [DBML](https://github.com/holistics/dbml) ⭐ 3,514 | 🐛 105 | 🌐 JavaScript | 📅 2026-02-13 - Database Markup Language, designed to define and document database structures.
...
* [pgmodeler](https://github.com/pgmodeler/pgmodeler) ⭐ 3,481 | 🐛 264 | 🌐 C++ | 📅 2026-02-06 - Data modeling tool designed for PostgreSQL.
...
* [Oracle Database Sample Schemas](https://github.com/oracle/db-sample-schemas) ⭐ 891 | 🐛 3 | 🌐 PLSQL | 📅 2025-06-25 - Sample schemas for Oracle Database.

## API

Building API for your Data

* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,899 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-12 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,512 | 🐛 380 | 🌐 Haskell | 📅 2026-02-13 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 143 | 🌐 TypeScript | 📅 2026-02-11 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,747 | 🐛 653 | 🌐 Python | 📅 2026-02-11 - A tool for exploring and publishing data.
...
* [sandman2](https://github.com/jeffknupp/sandman2) ⭐ 2,044 | 🐛 45 | 🌐 Python | 📅 2026-02-09 - Automatically generate a RESTful API service for your legacy database.
* [DreamFactory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,738 | 🐛 64 | 🌐 Shell | 📅 2026-02-11 - A open source REST API backend for mobile, web, and IoT applications.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 546 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-13 - Turn multiple data sources into a single GraphQL API.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,088 | 🐛 4,433 | 🌐 TypeScript | 📅 2026-02-12 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,429 | 🐛 991 | 🌐 JavaScript | 📅 2026-02-12 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,639 | 🐛 308 | 🌐 TypeScript | 📅 2026-02-12 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,369 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-11 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,078 | 🐛 109 | 🌐 TypeScript | 📅 2026-02-12 - The Open Source Firebase Alternative with GraphQL.
...
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,992 | 🐛 674 | 🌐 JavaScript | 📅 2026-02-12 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,509 | 🐛 5 | 🌐 Go | 📅 2026-02-10 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,597 | 🐛 54 | 🌐 C | 📅 2026-02-13 - Reliable PostgreSQL Backup & Restore.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 325 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-12 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,691 | 🐛 447 | 🌐 Go | 📅 2026-02-12 - Provides metrics for your PostgreSQL database.
...
* [pgmetrics](https://github.com/rapidloop/pgmetrics) ⭐ 1,072 | 🐛 12 | 🌐 Go | 📅 2026-01-18 - Collect and display information and stats from a running PostgreSQL server.
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 965 | 🐛 171 | 🌐 Go | 📅 2026-02-13 - Open source platform for managing and monitoring MySQL and MongoDB performance.
* [pgMonitor](https://github.com/CrunchyData/pgmonitor) ⭐ 696 | 🐛 16 | 🌐 PLpgSQL | 📅 2026-02-05 - All-in-one tool to easily create an environment to visualize the health and performance of your PostgreSQL cluster.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 387 | 🐛 36 | 🌐 Go | 📅 2026-02-12 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,408 | 🐛 344 | 🌐 Go | 📅 2026-02-11 - Prometheus exporter for PostgreSQL server metrics.
* [pg\_exporter](https://github.com/Vonng/pg_exporter) ⭐ 297 | 🐛 13 | 🌐 Go | 📅 2026-02-12 - Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,695 | 🐛 910 | 🌐 Go | 📅 2026-02-13 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,676 | 🐛 351 | 🌐 Java | 📅 2026-02-12 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,285 | 🐛 1,049 | 🌐 C | 📅 2026-02-12 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,152 | 🐛 74 | 🌐 Python | 📅 2026-01-29 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,918 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-09 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [PostgreSQL operator](https://github.com/zalando/postgres-operator) ⭐ 5,082 | 🐛 556 | 🌐 Go | 📅 2026-02-12 - The PostgreSQL Operator enables highly-available PostgreSQL clusters on Kubernetes (Kubernetes) powered by Patroni.
* [Spilo](https://github.com/zalando/spilo) ⭐ 1,785 | 🐛 144 | 🌐 Python | 📅 2026-02-12 - HA PostgreSQL Clusters with Docker.
...
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,434 | 🐛 37 | 🌐 Perl | 📅 2026-01-18 - Script written in Perl that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,692 | 🐛 146 | 🌐 Makefile | 📅 2026-02-12 - Full-featured PostgreSQL installation packaged as a standard Mac app.
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,666 | 🐛 16 | 🌐 Shell | 📅 2026-02-13 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,725 | 🐛 176 | 🌐 PowerShell | 📅 2026-02-12 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,502 | 🐛 589 | 🌐 Python | 📅 2026-02-12 - Dialect-flexible and configurable SQL linter.
...
* [ZetaSQL](https://github.com/google/zetasql) ⭐ 2,599 | 🐛 102 | 🌐 C++ | 📅 2026-01-31 - Analyzer Framework for SQL.

### Formatters

* [SQL Formatter](https://github.com/zeroturnaround/sql-formatter) ⭐ 2,816 | 🐛 73 | 🌐 TypeScript | 📅 2026-01-30 - JavaScript library for pretty-printing SQL queries.
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,900 | 🐛 20 | 🌐 PLpgSQL | 📅 2026-02-05 - A PostgreSQL SQL syntax beautifier.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,906 | 🐛 7 | 🌐 Python | 📅 2026-02-12 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,658 | 🐛 2,148 | 🌐 Java | 📅 2026-02-12 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,913 | 🐛 107 | 🌐 Java | 📅 2026-02-12 - Parses an SQL statement and translate it into a hierarchy of Java classes.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,102 | 🐛 670 | 🌐 C++ | 📅 2026-02-11 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,543 | 🐛 2,523 | 🌐 Java | 📅 2026-02-13 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 39 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,693 | 🐛 22 | 🌐 Go | 📅 2026-02-10 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,322 | 🐛 126 | 🌐 Go | 📅 2026-02-12 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
* [OctoSQL](https://github.com/cube2222/octosql) ⭐ 5,213 | 🐛 49 | 🌐 Go | 📅 2024-05-26 - Query tool that allows you to join, analyse and transform data from multiple databases and file formats using SQL.
...
* [MAT Calcite plugin](https://github.com/vlsi/mat-calcite-plugin) ⭐ 175 | 🐛 12 | 🌐 Java | 📅 2025-12-22 - This plugin for Eclipse Memory Analyzer allows to query heap dump via SQL.
* [Resmo](https://www.resmo.com) - Audit and evaluate resources using SQL.

### Language Server Protocol

* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,259 | 🐛 44 | 🌐 Go | 📅 2026-01-07 - SQL Language Server written in Go.
...
* [Advanced SQL Puzzles](https://github.com/smpetersgithub/AdvancedSQLPuzzles) ⭐ 847 | 🐛 0 | 🌐 TSQL | 📅 2026-01-23 - Difficult set-based SQL puzzles.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,352 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-02 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [postgres\_dba](https://github.com/NikolayS/postgres_dba) ⭐ 1,217 | 🐛 1 | 🌐 PLpgSQL | 📅 2026-02-10 - The missing set of useful tools for PostgreSQL DBAs and all engineers.
* [pg-utils](https://github.com/dataegret/pg-utils) ⭐ 1,186 | 🐛 6 | 🌐 Shell | 📅 2025-12-05 - Useful PostgreSQL utilities.
* [TPT](https://github.com/tanelpoder/tpt-oracle) ⭐ 711 | 🐛 16 | 🌐 PLSQL | 📅 2026-01-14 - These sqlplus scripts are for Oracle Database performance optimization & troubleshooting.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,238 | 🐛 813 | 🌐 Python | 📅 2026-02-12 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,576 | 🐛 748 | 🌐 Java | 📅 2026-02-13 - The Metadata Platform for the Modern Data Stack.
...
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,120 | 🐛 238 | 🌐 Java | 📅 2026-02-11 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,865 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-12 - Generate massive amounts of fake data in the browser and Node.js.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,188 | 🐛 36 | 🌐 Go | 📅 2026-02-12 - Streaming replication for SQLite.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,428 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Sync PostgreSQL data between databases.
...
* [pg\_chameleon](https://github.com/the4thdoctor/pg_chameleon) ⭐ 428 | 🐛 45 | 🌐 Python | 📅 2025-01-21 - MySQL to PostgreSQL replica system written in Python 3. The system use the library mysql-replication to pull the row images from MySQL which are stored into PostgreSQL as JSONB.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,449 | 🐛 175 | 🌐 Python | 📅 2026-02-12 - In-database Machine Learning.
