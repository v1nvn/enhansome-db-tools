...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 49,009 | 🐛 3,260 | 🌐 Java | 📅 2026-03-09 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,831 | 🐛 370 | 🌐 Pascal | 📅 2026-03-09 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 34,010 | 🐛 177 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 22,166 | 🐛 1,043 | 🌐 TypeScript | 📅 2026-03-10 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
* [Robo 3T](https://github.com/Studio3T/robomongo) ⭐ 9,369 | 🐛 724 | 🌐 C++ | 📅 2022-09-22 - Shell-centric cross-platform MongoDB management tool.
* [Pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,268 | 🐛 43 | 🌐 Go | 📅 2026-03-01 - Web-based database browser for PostgreSQL, written in Go and works on macOS, Linux and Windows machines.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,819 | 🐛 927 | 🌐 PHP | 📅 2026-03-08 - A web interface for MySQL and MariaDB.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,319 | 🐛 193 | 🌐 Objective-C | 📅 2026-03-06 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,672 | 🐛 31 | 🌐 Go | 📅 2026-03-09 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,148 | 🐛 5 | 🌐 Java | 📅 2026-03-03 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [usql](https://github.com/xo/usql) ⭐ 9,858 | 🐛 101 | 🌐 Go | 📅 2026-03-03 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [iredis](https://github.com/laixintao/iredis) ⭐ 2,728 | 🐛 50 | 🌐 Python | 📅 2026-03-03 - A Cli for Redis with AutoCompletion and Syntax Highlighting.
* [pspg](https://github.com/okbob/pspg) ⭐ 2,697 | 🐛 0 | 🌐 C | 📅 2026-02-18 - PostgreSQL Pager.
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,017 | 🐛 137 | 🌐 Python | 📅 2026-01-21 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,064 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - PostgreSQL CLI with autocompletion and syntax highlighting.
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,887 | 🐛 14 | 🌐 Python | 📅 2026-03-09 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,801 | 🐛 143 | 🌐 Go | 📅 2026-03-10 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,241 | 🐛 322 | 🌐 Go | 📅 2026-03-09 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,581 | 🐛 243 | 🌐 Java | 📅 2026-03-09 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,148 | 🐛 248 | 🌐 Go | 📅 2026-03-08 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,446 | 🐛 638 | 🌐 Java | 📅 2026-03-09 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,023 | 🐛 7 | 🌐 Go | 📅 2026-03-09 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,444 | 🐛 54 | 🌐 TypeScript | 📅 2026-03-09 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,846 | 🐛 195 | 🌐 JavaScript | 📅 2026-03-08 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,473 | 🐛 140 | 🌐 TypeScript | 📅 2026-03-04 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,729 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-01 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
...
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,552 | 🐛 297 | 🌐 HTML | 📅 2026-03-05 - Generating your database to HTML documentation, including Entity Relationship diagrams.
* [DBML](https://github.com/holistics/dbml) ⭐ 3,535 | 🐛 110 | 🌐 JavaScript | 📅 2026-03-09 - Database Markup Language, designed to define and document database structures.
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,787 | 🐛 0 | 🌐 HTML | 📅 2026-03-10 - A free database schema discovery and comprehension tool.
* [dbdocs](https://dbdocs.io/) - Create web-based database documentation using DSL code.

### Design

* [pgmodeler](https://github.com/pgmodeler/pgmodeler) ⭐ 3,521 | 🐛 268 | 🌐 C++ | 📅 2026-03-09 - Data modeling tool designed for PostgreSQL.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,915 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-10 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,631 | 🐛 384 | 🌐 Haskell | 📅 2026-03-10 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,911 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-09 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,814 | 🐛 663 | 🌐 Python | 📅 2026-03-10 - A tool for exploring and publishing data.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,354 | 🐛 4,442 | 🌐 TypeScript | 📅 2026-03-09 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,567 | 🐛 960 | 🌐 JavaScript | 📅 2026-03-10 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,720 | 🐛 308 | 🌐 TypeScript | 📅 2026-03-09 - Low-code platform for creating internal apps in minutes.
...
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,097 | 🐛 101 | 🌐 TypeScript | 📅 2026-03-09 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,474 | 🐛 117 | 🌐 Rust | 📅 2026-03-09 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,995 | 🐛 670 | 🌐 JavaScript | 📅 2026-03-09 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,905 | 🐛 3 | 🌐 Go | 📅 2026-03-09 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,644 | 🐛 65 | 🌐 C | 📅 2026-03-07 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 2,739 | 🐛 58 | 🌐 Python | 📅 2026-01-20 - Backup and Recovery Manager for PostgreSQL.
* [pgcopydb](https://github.com/dimitri/pgcopydb) ⭐ 1,422 | 🐛 95 | 🌐 C | 📅 2025-04-28 - Copy a PostgreSQL database to a target PostgreSQL server (pg\_dump | pg\_restore on steroids).
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 558 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-08 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,757 | 🐛 452 | 🌐 Go | 📅 2026-03-09 - Provides metrics for your PostgreSQL database.
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,803 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - A performance dashboard for PostgreSQL - health checks, suggested indexes, and more.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 984 | 🐛 176 | 🌐 Go | 📅 2026-03-10 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [RegreSQL](https://github.com/dimitri/regresql) ⭐ 351 | 🐛 4 | 🌐 Go | 📅 2024-09-04 - Regression Testing your SQL queries.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,899 | 🐛 938 | 🌐 Go | 📅 2026-03-10 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,704 | 🐛 323 | 🌐 Java | 📅 2026-03-09 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,357 | 🐛 1,046 | 🌐 C | 📅 2026-03-09 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,216 | 🐛 72 | 🌐 Python | 📅 2026-03-05 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,013 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-09 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,733 | 🐛 176 | 🌐 PowerShell | 📅 2026-03-09 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [Databunker](https://github.com/securitybunker/databunker) ⭐ 1,390 | 🐛 5 | 🌐 Go | 📅 2026-02-19 - Special GDPR compliant secure vault for customer records built on top of regular DB.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,582 | 🐛 541 | 🌐 Python | 📅 2026-03-10 - Dialect-flexible and configurable SQL linter.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,911 | 🐛 20 | 🌐 PLpgSQL | 📅 2026-03-06 - A PostgreSQL SQL syntax beautifier.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,998 | 🐛 4 | 🌐 Python | 📅 2026-03-10 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,678 | 🐛 2,129 | 🌐 Java | 📅 2026-03-09 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,159 | 🐛 658 | 🌐 C++ | 📅 2026-03-09 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,623 | 🐛 2,567 | 🌐 Java | 📅 2026-03-10 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,118 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,727 | 🐛 24 | 🌐 Go | 📅 2026-03-09 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,338 | 🐛 156 | 🌐 Go | 📅 2026-03-09 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,410 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-09 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [postgres\_dba](https://github.com/NikolayS/postgres_dba) ⭐ 1,242 | 🐛 3 | 🌐 PLpgSQL | 📅 2026-02-10 - The missing set of useful tools for PostgreSQL DBAs and all engineers.
* [pg-utils](https://github.com/dataegret/pg-utils) ⭐ 1,193 | 🐛 6 | 🌐 Shell | 📅 2025-12-05 - Useful PostgreSQL utilities.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,358 | 🐛 775 | 🌐 Python | 📅 2026-03-10 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,633 | 🐛 778 | 🌐 Java | 📅 2026-03-10 - The Metadata Platform for the Modern Data Stack.
* [Amundsen](https://github.com/amundsen-io/amundsen) ⭐ 4,746 | 🐛 44 | 🌐 Python | 📅 2026-03-01 - Metadata driven application for improving the productivity of data analysts, data scientists and engineers when interacting with data.
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,134 | 🐛 241 | 🌐 Java | 📅 2026-03-08 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,958 | 🐛 128 | 🌐 TypeScript | 📅 2026-03-10 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,416 | 🐛 298 | 🌐 Python | 📅 2026-03-03 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,326 | 🐛 27 | 🌐 Go | 📅 2026-03-10 - Streaming replication for SQLite.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,433 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Sync PostgreSQL data between databases.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,660 | 🐛 192 | 🌐 Python | 📅 2026-03-09 - In-database Machine Learning.
