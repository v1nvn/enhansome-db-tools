...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 49,022 | 🐛 3,263 | 🌐 Java | 📅 2026-03-10 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,836 | 🐛 370 | 🌐 Pascal | 📅 2026-03-10 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 34,017 | 🐛 177 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 22,172 | 🐛 1,045 | 🌐 TypeScript | 📅 2026-03-11 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,822 | 🐛 927 | 🌐 PHP | 📅 2026-03-10 - A web interface for MySQL and MariaDB.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,320 | 🐛 193 | 🌐 Objective-C | 📅 2026-03-06 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,673 | 🐛 31 | 🌐 Go | 📅 2026-03-10 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
* [TablePlus](https://github.com/TablePlus/TablePlus) ⭐ 3,726 | 🐛 1,407 | 📅 2026-03-02 - Modern, native, and friendly GUI tool for relational databases: MySQL, PostgreSQL, SQLite & more.
* [OmniDB](https://github.com/OmniDB/OmniDB) ⭐ 3,282 | 🐛 329 | 🌐 JavaScript | 📅 2023-02-01 - Web tool for database management.
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,151 | 🐛 5 | 🌐 Java | 📅 2026-03-10 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [usql](https://github.com/xo/usql) ⭐ 9,859 | 🐛 101 | 🌐 Go | 📅 2026-03-03 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,065 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - PostgreSQL CLI with autocompletion and syntax highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,803 | 🐛 141 | 🌐 Go | 📅 2026-03-11 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,241 | 🐛 323 | 🌐 Go | 📅 2026-03-09 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,582 | 🐛 245 | 🌐 Java | 📅 2026-03-09 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,152 | 🐛 246 | 🌐 Go | 📅 2026-03-08 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,449 | 🐛 609 | 🌐 Java | 📅 2026-03-10 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,026 | 🐛 7 | 🌐 Go | 📅 2026-03-10 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,444 | 🐛 54 | 🌐 TypeScript | 📅 2026-03-11 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 36,857 | 🐛 195 | 🌐 JavaScript | 📅 2026-03-08 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,483 | 🐛 140 | 🌐 TypeScript | 📅 2026-03-04 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,731 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-01 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
...
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,553 | 🐛 297 | 🌐 HTML | 📅 2026-03-05 - Generating your database to HTML documentation, including Entity Relationship diagrams.
...
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,787 | 🐛 0 | 🌐 HTML | 📅 2026-03-11 - A free database schema discovery and comprehension tool.
* [dbdocs](https://dbdocs.io/) - Create web-based database documentation using DSL code.

### Design

* [pgmodeler](https://github.com/pgmodeler/pgmodeler) ⭐ 3,521 | 🐛 269 | 🌐 C++ | 📅 2026-03-10 - Data modeling tool designed for PostgreSQL.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,637 | 🐛 384 | 🌐 Haskell | 📅 2026-03-10 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,912 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-11 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 10,819 | 🐛 663 | 🌐 Python | 📅 2026-03-10 - A tool for exploring and publishing data.
...
* [DreamFactory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,747 | 🐛 64 | 🌐 Shell | 📅 2026-03-10 - A open source REST API backend for mobile, web, and IoT applications.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 548 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-10 - Turn multiple data sources into a single GraphQL API.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,359 | 🐛 4,445 | 🌐 TypeScript | 📅 2026-03-11 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,584 | 🐛 963 | 🌐 JavaScript | 📅 2026-03-11 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,724 | 🐛 312 | 🌐 TypeScript | 📅 2026-03-11 - Low-code platform for creating internal apps in minutes.
...
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,098 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-10 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,475 | 🐛 117 | 🌐 Rust | 📅 2026-03-10 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,995 | 🐛 671 | 🌐 JavaScript | 📅 2026-03-10 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,923 | 🐛 4 | 🌐 Go | 📅 2026-03-10 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,647 | 🐛 65 | 🌐 C | 📅 2026-03-07 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 2,741 | 🐛 58 | 🌐 Python | 📅 2026-01-20 - Backup and Recovery Manager for PostgreSQL.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 562 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-08 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,759 | 🐛 446 | 🌐 Go | 📅 2026-03-10 - Provides metrics for your PostgreSQL database.
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,804 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - A performance dashboard for PostgreSQL - health checks, suggested indexes, and more.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 984 | 🐛 175 | 🌐 Go | 📅 2026-03-10 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,439 | 🐛 346 | 🌐 Go | 📅 2026-03-04 - Prometheus exporter for PostgreSQL server metrics.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,904 | 🐛 941 | 🌐 Go | 📅 2026-03-11 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,704 | 🐛 326 | 🌐 Java | 📅 2026-03-10 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,360 | 🐛 1,045 | 🌐 C | 📅 2026-03-10 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,222 | 🐛 72 | 🌐 Python | 📅 2026-03-05 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,015 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,703 | 🐛 146 | 🌐 Makefile | 📅 2026-03-05 - Full-featured PostgreSQL installation packaged as a standard Mac app.
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,862 | 🐛 19 | 🌐 Shell | 📅 2026-03-05 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,734 | 🐛 160 | 🌐 PowerShell | 📅 2026-03-10 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,583 | 🐛 532 | 🌐 Python | 📅 2026-03-10 - Dialect-flexible and configurable SQL linter.
...
* [ZetaSQL](https://github.com/google/zetasql) ⭐ 2,613 | 🐛 103 | 🌐 C++ | 📅 2026-01-31 - Analyzer Framework for SQL.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,003 | 🐛 7 | 🌐 Python | 📅 2026-03-10 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,678 | 🐛 2,131 | 🌐 Java | 📅 2026-03-10 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,162 | 🐛 661 | 🌐 C++ | 📅 2026-03-09 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,627 | 🐛 2,564 | 🌐 Java | 📅 2026-03-11 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
...
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,338 | 🐛 154 | 🌐 Go | 📅 2026-03-10 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,274 | 🐛 43 | 🌐 Go | 📅 2026-03-07 - SQL Language Server written in Go.
...
* [Advanced SQL Puzzles](https://github.com/smpetersgithub/AdvancedSQLPuzzles) ⭐ 860 | 🐛 0 | 🌐 TSQL | 📅 2026-01-23 - Difficult set-based SQL puzzles.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,415 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-09 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [postgres\_dba](https://github.com/NikolayS/postgres_dba) ⭐ 1,243 | 🐛 3 | 🌐 PLpgSQL | 📅 2026-02-10 - The missing set of useful tools for PostgreSQL DBAs and all engineers.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,363 | 🐛 775 | 🌐 Python | 📅 2026-03-11 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,637 | 🐛 777 | 🌐 Java | 📅 2026-03-11 - The Metadata Platform for the Modern Data Stack.
* [Amundsen](https://github.com/amundsen-io/amundsen) ⭐ 4,746 | 🐛 45 | 🌐 Python | 📅 2026-03-10 - Metadata driven application for improving the productivity of data analysts, data scientists and engineers when interacting with data.
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,136 | 🐛 241 | 🌐 Java | 📅 2026-03-08 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,961 | 🐛 127 | 🌐 TypeScript | 📅 2026-03-10 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,420 | 🐛 298 | 🌐 Python | 📅 2026-03-03 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,327 | 🐛 25 | 🌐 Go | 📅 2026-03-11 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,668 | 🐛 186 | 🌐 Python | 📅 2026-03-10 - In-database Machine Learning.
