...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 48,599 | 🐛 3,229 | 🌐 Java | 📅 2026-02-07 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 5,792 | 🐛 469 | 🌐 Pascal | 📅 2026-02-07 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 33,901 | 🐛 173 | 🌐 JavaScript | 📅 2025-10-16 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 21,955 | 🐛 1,039 | 🌐 TypeScript | 📅 2026-02-07 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
...
* [Sequel Pro](https://github.com/sequelpro/sequelpro) ⭐ 9,203 | 🐛 529 | 🌐 Objective-C | 📅 2023-02-25 - Fast, easy-to-use Mac database management application for working with MySQL & MariaDB databases.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,791 | 🐛 908 | 🌐 PHP | 📅 2026-02-08 - A web interface for MySQL and MariaDB.
...
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,254 | 🐛 20 | 🌐 PHP | 📅 2026-02-08 - Database management in a single PHP file.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 4,550 | 🐛 32 | 🌐 Go | 📅 2026-02-08 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
...
* [Antares SQL](https://github.com/antares-sql/antares) ⭐ 2,546 | 🐛 143 | 🌐 Vue | 📅 2025-10-14 - A modern, fast and productivity driven SQL client with a focus in UX. Available for Mac, Linux and Windows.
...
* [SQLTools](https://github.com/mtxr/vscode-sqltools) ⭐ 1,718 | 🐛 313 | 🌐 TypeScript | 📅 2026-02-07 - Database management for VSCode.
...
* [usql](https://github.com/xo/usql) ⭐ 9,804 | 🐛 101 | 🌐 Go | 📅 2026-01-11 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,869 | 🐛 18 | 🌐 Python | 📅 2026-02-07 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,182 | 🐛 37 | 🌐 Python | 📅 2026-01-31 - CLI for SQLite Databases with auto-completion and syntax highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 13,703 | 🐛 146 | 🌐 Go | 📅 2026-02-09 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,205 | 🐛 320 | 🌐 Go | 📅 2026-01-30 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 9,517 | 🐛 238 | 🌐 Java | 📅 2026-01-28 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,060 | 🐛 239 | 🌐 Go | 📅 2026-02-07 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,415 | 🐛 676 | 🌐 Java | 📅 2026-02-04 - Database-independent library for tracking, managing and applying database schema changes.
...
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 2,808 | 🐛 5 | 🌐 Go | 📅 2026-02-05 - Idempotent schema management for MySQL, PostgreSQL, and more.
* [Reshape](https://github.com/fabianlindfors/reshape) ⭐ 1,823 | 🐛 10 | 🌐 Rust | 📅 2026-02-06 - An easy-to-use, zero-downtime schema migration tool for Postgres.
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,440 | 🐛 55 | 🌐 TypeScript | 📅 2026-02-09 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
* [Skeema](https://github.com/skeema/skeema) ⭐ 1,358 | 🐛 17 | 🌐 Go | 📅 2026-02-04 - Declarative pure-SQL schema management system for MySQL and MariaDB, with support for sharding and external online schema change tools.
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 35,931 | 🐛 176 | 🌐 JavaScript | 📅 2026-02-07 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 21,101 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-03 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 4,688 | 🐛 27 | 🌐 TypeScript | 📅 2026-02-08 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
...
* [tbls](https://github.com/k1LoW/tbls) ⭐ 4,140 | 🐛 54 | 🌐 Go | 📅 2026-01-16 - CI-Friendly tool for document a database, written in Go.
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,535 | 🐛 297 | 🌐 HTML | 📅 2026-01-26 - Generating your database to HTML documentation, including Entity Relationship diagrams.
* [DBML](https://github.com/holistics/dbml) ⭐ 3,510 | 🐛 104 | 🌐 JavaScript | 📅 2026-02-09 - Database Markup Language, designed to define and document database structures.
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,782 | 🐛 0 | 🌐 HTML | 📅 2026-02-09 - A free database schema discovery and comprehension tool.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,893 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-06 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,480 | 🐛 371 | 🌐 Haskell | 📅 2026-02-08 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-07 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 546 | 🐛 18 | 🌐 TypeScript | 📅 2026-02-09 - Turn multiple data sources into a single GraphQL API.
...
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 39,056 | 🐛 4,432 | 🌐 TypeScript | 📅 2026-02-06 - Powerful open source low code framework to build internal applications really quickly.
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 37,406 | 🐛 981 | 🌐 JavaScript | 📅 2026-02-09 - Open-source low-code platform to build internal tools.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 27,626 | 🐛 304 | 🌐 TypeScript | 📅 2026-02-08 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,367 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-06 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,069 | 🐛 102 | 🌐 TypeScript | 📅 2026-02-08 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,435 | 🐛 113 | 🌐 Rust | 📅 2026-02-07 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 1,990 | 🐛 669 | 🌐 JavaScript | 📅 2026-02-08 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 5,433 | 🐛 6 | 🌐 Go | 📅 2026-02-08 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 3,587 | 🐛 54 | 🌐 C | 📅 2026-02-08 - Reliable PostgreSQL Backup & Restore.
...
* [Portabase](https://github.com/Portabase/portabase) ⭐ 319 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-08 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 16,685 | 🐛 441 | 🌐 Go | 📅 2026-02-06 - Provides metrics for your PostgreSQL database.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 962 | 🐛 173 | 🌐 Go | 📅 2026-02-09 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 386 | 🐛 38 | 🌐 Go | 📅 2026-02-07 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [pg\_exporter](https://github.com/Vonng/pg_exporter) ⭐ 294 | 🐛 13 | 🌐 Go | 📅 2026-02-08 - Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control.
...
* [SQLancer](https://github.com/sqlancer/sqlancer) ⭐ 1,692 | 🐛 148 | 🌐 Java | 📅 2025-11-23 - Automatically test DBMS in order to find logic bugs in their implementation.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 20,681 | 🐛 899 | 🌐 Go | 📅 2026-02-09 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,672 | 🐛 362 | 🌐 Java | 📅 2026-02-09 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,272 | 🐛 1,054 | 🌐 C | 📅 2026-02-06 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,143 | 🐛 71 | 🌐 Python | 📅 2026-01-29 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,908 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-09 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,322 | 🐛 121 | 🌐 C | 📅 2025-11-17 - PostgreSQL extension and service for automated failover and high-availability.
...
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,429 | 🐛 37 | 🌐 Perl | 📅 2026-01-18 - Script written in Perl that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,640 | 🐛 14 | 🌐 Shell | 📅 2026-02-09 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,725 | 🐛 179 | 🌐 PowerShell | 📅 2026-02-08 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,480 | 🐛 589 | 🌐 Python | 📅 2026-02-09 - Dialect-flexible and configurable SQL linter.
...
* [ZetaSQL](https://github.com/google/zetasql) ⭐ 2,590 | 🐛 102 | 🌐 C++ | 📅 2026-01-31 - Analyzer Framework for SQL.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,892 | 🐛 35 | 🌐 Python | 📅 2026-02-06 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,653 | 🐛 2,153 | 🌐 Java | 📅 2026-02-05 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,908 | 🐛 114 | 🌐 Java | 📅 2026-01-26 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 3,991 | 🐛 255 | 🌐 Python | 📅 2025-12-19 - Non-validating SQL parser for Python.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,091 | 🐛 670 | 🌐 C++ | 📅 2026-02-04 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 12,531 | 🐛 2,511 | 🌐 Java | 📅 2026-02-08 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,119 | 🐛 39 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,685 | 🐛 31 | 🌐 Go | 📅 2026-02-07 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,320 | 🐛 156 | 🌐 Go | 📅 2026-02-07 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [SQL Murder Mystery](https://github.com/NUKnightLab/sql-mysteries) ⭐ 2,017 | 🐛 19 | 🌐 JavaScript | 📅 2025-04-14 - Self-directed lesson to learn SQL concepts and commands and a fun game for experienced SQL users to solve an intriguing crime.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,346 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-02 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
...
* [postgres\_dba](https://github.com/NikolayS/postgres_dba) ⭐ 1,217 | 🐛 17 | 🌐 PLpgSQL | 📅 2026-02-09 - The missing set of useful tools for PostgreSQL DBAs and all engineers.
...
* [pgsql-bloat-estimation](https://github.com/ioguix/pgsql-bloat-estimation) ⭐ 564 | 🐛 5 | 📅 2022-08-23 - Queries to mesure statistical bloat in indexes and tables for PostgreSQL.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 12,219 | 🐛 802 | 🌐 Python | 📅 2026-02-08 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 11,550 | 🐛 733 | 🌐 Java | 📅 2026-02-09 - The Metadata Platform for the Modern Data Stack.
...
* [Marquez](https://github.com/MarquezProject/marquez) ⭐ 2,114 | 🐛 237 | 🌐 Java | 📅 2026-01-24 - Collect, aggregate, and visualize a data ecosystem's metadata.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 14,853 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-09 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,372 | 🐛 292 | 🌐 Python | 📅 2026-02-02 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 13,170 | 🐛 32 | 🌐 Go | 📅 2026-02-08 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,428 | 🐛 171 | 🌐 Python | 📅 2026-02-07 - In-database Machine Learning.
