...
* [pgmodeler](https://github.com/pgmodeler/pgmodeler) ⭐ 3,522 | 🐛 269 | 🌐 C++ | 📅 2026-03-11 - Data modeling tool designed for PostgreSQL.
...
* [SQL Formatter](https://github.com/zeroturnaround/sql-formatter) ⭐ 2,822 | 🐛 74 | 🌐 TypeScript | 📅 2026-02-17 - JavaScript library for pretty-printing SQL queries.
...
* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,276 | 🐛 43 | 🌐 Go | 📅 2026-03-07 - SQL Language Server written in Go.
...
* [pev2](https://github.com/dalibo/pev2) ⭐ 3,417 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - A Vue.js component to show a graphical vizualization of a PostgreSQL execution plan.
